...
class MeloTTSProvider(TTSProvider):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            logger.warning("MeloTTS provider will be disabled. Install with: pip install voicegenhub[melotts]")
    ...
    async def synthesize(self, request: TTSRequest) -> TTSResponse:
        ...
        try:
            ...
            if self.model is None:
                ...
                language_code = speaker_name.split("-")[0] if "-" in speaker_name else speaker_name
